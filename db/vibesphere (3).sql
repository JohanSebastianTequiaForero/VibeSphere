...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2025 a las 17:55:08
...
INSERT INTO `usuarios` (`usuario_id`, `nombre_usuario`, `nombre`, `apellidos`, `correo`, `password`, `rol_id`, `created_at`, `updated_at`) VALUES
(1, 'temp_user_1', 'Carlos', 'Gómez', 'carlos@example.com', '123456', 1, '2025-09-01 18:34:14', '2025-09-02 05:52:21'),
(2, 'temp_user_2', 'Ana', 'López', 'ana@example.com', '123456', 2, '2025-09-01 18:34:48', '2025-09-02 05:52:21'),
(3, 'Catica_music', 'Catalina', 'Moreno Diaz', 'catatalinamore@gmail.com', 'moreno789.cata', 1, '2025-09-02 06:02:32', '2025-09-02 06:02:32'),
(4, 'Instituto letras de la musica', 'Monica', 'Agudelo Torres', 'instituto.letras@educacion.edu.co', 'letras2025.musica', 2, '2025-09-02 06:14:49', '2025-09-02 06:14:49'),
(5, 'JOSELE', 'Jose', 'Ceballos Cardoso', 'jose.ceballos23@hotmail.com', 'jose.CC', 2, '2025-09-03 21:56:54', '2025-09-03 21:56:54'),
(6, 'Maluma_oficial', 'Juan', 'Londoño Arias', 'malumita.music@hotmail.com', 'malumita.arias', 1, '2025-09-03 22:04:35', '2025-09-03 22:04:35'),
(7, 'AndresCepeda23', 'Andres', 'Cepeda', 'CepedaAndres23@gmail.com', '674539', 1, '2025-09-03 22:16:50', '2025-09-03 22:16:50'),
(9, 'Sol_de_verano', 'Laura', 'Dominguez Rico', 'lauDomin@gmail.com', 'solecito.345', 1, '2025-09-03 22:43:47', '2025-09-03 22:43:47'),
(10, 'LaMega', 'Roberto', 'Galindo Mesa', 'Galindoberto543@gmail.com', 'mega.radio99', 2, '2025-09-03 23:06:42', '2025-09-03 23:06:42');
...
--
ALTER TABLE `artista_info`
  ADD CONSTRAINT `artista_info_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON DELETE CASCADE;
